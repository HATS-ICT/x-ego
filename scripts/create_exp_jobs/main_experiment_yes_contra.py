...
EXP_PREFIX = "main_exp_yes_contra_v2"
...
uv run python main.py --mode train --task {task} \\
  ...
  model.contrastive.logit_scale_init=10 \\
  model.contrastive.logit_bias_init=-10 \\
...
def main():
  ...
  meta.run_name={run_name}"""
    ...
    print(f"  - contrastive.logit_scale_init: 10")
    print(f"  - contrastive.logit_bias_init: -10")
